	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				$swalType = "success";
				$swalTitle = "La venta ha sido guardada correctamente";

				if(isset($_POST["impresion"])){

					try {

						$impresora = defined('IMPRESORA_NOMBRE') ? IMPRESORA_NOMBRE : "";

						if($impresora === ""){
							throw new Exception("No hay impresora configurada en config.php");
						}
						...
						$swalType = "warning";
						$swalTitle = "La venta se guardó, pero no se detectó ninguna impresora";
					}
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			if($respuesta == "ok"){
				...
				Conexion::revertirTransaccion();
				error_log("Error en ctrEditarVenta: " . $e->getMessage());
				echo '<script>swal({type:"error",title:"Error al editar la venta",showConfirmButton:true,confirmButtonText:"Cerrar"}).then(function(r){if(r.value){window.location="ventas";}})</script>';
			}
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			if($respuesta == "ok"){
				...
				Conexion::revertirTransaccion();
				error_log("Error en ctrEliminarVenta: " . $e->getMessage());
				echo '<script>swal({type:"error",title:"Error al eliminar la venta",showConfirmButton:true,confirmButtonText:"Cerrar"}).then(function(r){if(r.value){window.location="ventas";}})</script>';
			}
