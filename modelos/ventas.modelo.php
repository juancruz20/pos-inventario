...
class ModeloVentas{
	...
	static public function mdlRangoFechasVentas($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			$fechaLike = '%' . $fechaFinal . '%';
			$stmt -> bindParam(":fechaFinal", $fechaLike, PDO::PARAM_STR);
			...
			$stmt -> bindParam(":fechaFinal", ($fechaFinalMasUno == $fechaActualMasUno ? $fechaFinalMasUno : $fechaFinal), PDO::PARAM_STR);
